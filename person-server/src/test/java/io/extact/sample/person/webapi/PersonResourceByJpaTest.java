...
@AddConfig(key = "disable.bean", value = "io.extact.sample.person.persistence.file.FilePersonRepository")
@AddExtension(DisableAnotherPersistenceBeanExtension.class)
@ExtendWith(JulToSLF4DelegateExtension.class)
@TestMethodOrder(OrderAnnotation.class)
public class PersonResourceByJpaTest extends PersonResourceBaseTest {
}
